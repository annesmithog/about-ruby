...
require_relative '../../../lib/algorithms/sorting/radix_sort'

class RadixSortTest < Minitest::Test
  def test_already_sorted_array
    result = radix_sort([11, 12, 13])
    assert_equal result, [11, 12, 13]
  end

  def test_sort
    result = radix_sort([15, 14, 13, 12, 11])
  ...
  def test_single_element_array
    result = radix_sort([123])
    assert_equal result, [123]
  end

  def test_array_with_duplicates
    result = radix_sort([13, 12, 13, 10, 9, 11, 9, 11])
